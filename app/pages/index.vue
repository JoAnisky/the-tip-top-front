<template>
  <header class="relative w-full py-20 min-h-[500px] flex items-center">
    ...
    <picture class="absolute inset-0">
      ...
      <img src="/images/hero-bg-640.webp" alt="" class="absolute inset-0 w-full h-full object-cover" loading="eager" fetchpriority="high" aria-hidden="true"/>
    </picture>

    <div class="absolute inset-0 bg-black/60 z-0"></div>

    <div class="relative z-10 px-[var(--content-gutter)] w-full text-ttt-white">
      <div class="flex items-center justify-between max-w-6xl">
        ...
        <div class="max-w-4xl text-left">
          ...
          <Play/>
          <p class="mt-12 text-sm max-w-lg">
        ...
        <div class="flex-shrink-0 hidden lg:block pb-12">
          <img src="/images/jeu-concours.webp" alt="Illustration jeu concours" class="w-[244px] h-auto drop-shadow-2xl animate-float"/>
        </div>
