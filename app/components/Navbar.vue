...
const profileLink = computed(() => loggedIn.value ? '/profile' : '/login')
    ...
    <USlideover v-model="isOpen">
      <div class="p-6 bg-ttt-black h-full border-l border-ttt-white/10 overflow-y-auto">
        ...
        <div class="mt-auto border-t border-ttt-white/10 pt-8">
          <NuxtLink :to="profileLink" class="flex items-center gap-4 bg-ttt-white/10 p-4 rounded-xl hover:bg-ttt-white/20 transition-colors" @click="isOpen = false">
